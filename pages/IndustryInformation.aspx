<!--通知公告发布界面-->
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IndustryInformation.aspx.cs" Inherits="huaianyanjiuyuan_pages_Information" %>
<!DOCTYPE html>
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div>
            <div>
                <form id="newsForm" action="IndustryInformation.aspx" method="post" runat="server">
...
<script src="../JS/industryinformation.js"></script>
</body>
</html>
