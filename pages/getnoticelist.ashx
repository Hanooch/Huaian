<%@ WebHandler Language="C#" Class="getnoticelist" %>

using System;
using System.Web;
using System.Text;

public class getnoticelist : IHttpHandler {
    ...
    private string getprinItem()
    {
        ...
        string countcommand = "select count(*) from notice";
        int count = int.Parse(sqlOperation.ExecuteScalar(countcommand));
        string newscommand = "select ID,Title,Content,Releasetime from notice order by isTop desc,Releasetime desc";
