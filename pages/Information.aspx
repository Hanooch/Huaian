<!--研究院要闻发布界面-->
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Information.aspx.cs" Inherits="huaianyanjiuyuan_pages_Information" %>
<!DOCTYPE html>
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div>
            <div>
                <form id="newsForm" action="Information.aspx" method="post" runat="server">
